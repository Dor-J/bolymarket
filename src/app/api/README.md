...
| `/api/trades` | GET | Recent public Data API trades for an event. Requires `?eventId=&eventSlug=` |
...
- **Trades:** ~30s TTL on Polymarket Data API trade history responses.
...
| `trades/` | Data API `/trades` proxy for featured bid rails |
